...
class Example(object):
  ...
  def __init__(self, features, tokenizer, max_sequence_length,):
    ...
    # self.heads= features['heads']
    # self.relns= features['relns']
    # self.words= features ['words']
...
def main():
  ...
  parser.add_argument(
      "--preprocessed-data-file", default="data/untitled.json",
      help="Location of preprocessed data (JSON file); see the README for "
           "expected data format.")
  parser.add_argument("--bert-dir", default="bert/uncased_L-12_H-768_A-12",
  ...
  parser.add_argument("--word_level", default=True, action='store_true',
  ...
  with tf.Session() as sess:
    ...
    for batch_of_examples in examples_in_batches(examples, args.batch_size):
      ...
      for e, e_attn in zip(batch_of_examples, attns):
        ...
        e.features["relns"]=e.relns
        e.features['words']=e.words
        e.features['heads']=e.heads
